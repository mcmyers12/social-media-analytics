...
ga.matrix<-as.matrix(read.table("/Users/mirandamyers/Documents/Johns Hopkins University/r-scripts/gray-adj.csv", #the name of the adjacency matrix
...
ga.attr<-read.csv("/Users/mirandamyers/Documents/Johns Hopkins University/r-scripts/gray-attr.csv",  #the name of the attributes file
                  header=TRUE, 
                  sep=",", 
